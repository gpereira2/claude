...
First, create a new project directory and initialise it. We'll use a separate directory
...
<!-- Celebrate! Summarise what they accomplished. -->
...
- Write the first draft in plain language — optimise for clarity, not eloquence
